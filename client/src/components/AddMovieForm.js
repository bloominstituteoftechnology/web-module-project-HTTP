...
const AddMovieForm = (props) => {
    console.log('Heres AddMoveForm props: ', props);
    ...
    const handleSubmit = (e) => {
        ...
        axios.post(`http://localhost:5000/api/movies/`, movie)
            .then(res => {
                ...
                props.setMovies(res.data);//17 Make sure your component has access to and runs and modifications needed to global state and redirects to `/movies` after creation.
                push(`/movies`);
            })
            .catch(err => {
                console.log(err);
